...
public class PrimitiveEx {
  ...
  public static void main(String[] args) {
    ...
    // 비트와 바이트
    // 1. 비트   : 0 또는 1을 저장할 수 있는 최소 저장 단뒤
    ...
    
    {
      ...
      int c;
      long d;
      a = Byte.MAX_VALUE;     System.out.println(a + " " + "byte");
      b = Short.MAX_VALUE;    System.out.println(b + " " + "short");
      c = Integer.MAX_VALUE;  System.out.println(c + " " + "int");
      d = Long.MAX_VALUE;     System.out.println(d + " " + "long");
      
      // long 타입 주의점 (int 범위를 벗어나는 값의 리터럴 작성 시 반드시 마지막에 l 또는 L을 추가합니다.)
      d = 2147483648L;
    }
    
    {
      ...
      a = 1.5f; System.out.println(a + " " + "float");  // float은 사용하지 않습니다.
      b = 2.5;  System.out.println(b + " " + "double");
    }
