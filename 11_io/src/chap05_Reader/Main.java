...
//         sb.append(cbuf); // 테스트 해 보세요.
  ...
  public static void bufferedReader() {
     ...
     * 
     * 1. 문자 기반의 입력 스트림에 버퍼링 기능을 제공하는 보조스트림 클래스입니다.
...
//    try (InputStreamReader in = new InputStreamReader(new FileInputStream(file))) {  한글이 깨지지 않지만, 버퍼링 안돼서 성능이 떨어짐.
    ...
    try (BufferedReader in = new BufferedReader(new InputStreamReader(new FileInputStream(file)))) {
      ...
      */
      ...
      // BufferedReader를 사용하는 경우 아래와 같이 읽기를 추천합니다.
      String line = null;
      while ((line = in.readLine()) != null) {
