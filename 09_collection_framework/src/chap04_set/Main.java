 ...
 * 2. 데이터를 키(Key)-값(Value) 형태로 저장하며, 키(Key)를 해시 함수에 넣어 얻는 해시값을 배열의 인덱스로 사용해 값을 저장합니다.
 * 3. 빠른 검색, 삽입, 수정이 가능합니다.
 * 
 * 
 * 예시) 뽀로로, 루피, 에디, 포비, 크롱 데이터 저장하기
 * 
 * - Key   : 이름을 사용
...
public class Main {
  ...
  public static void hashSet() {
    ...
    // hobbies.get(0), hobbies.remove(0), 일반 for문 등
