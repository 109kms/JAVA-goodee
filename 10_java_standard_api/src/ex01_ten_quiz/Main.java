...
public class Main {
  ...
  public static void method1() {
    ...
    String newFileName = randomText.replace("-", "").substring(10);
    ...
    System.out.println(newFileName + "_" + timeStamp + extension);
...
//  }
  ...
  public static void method4() {
    ...
    while(balance > 0) {
      ...
      int before = balance;
      balance -= withdraw;
      System.out.println("출금 전 " + before + "원, " + count + "회 출금액 " + withdraw + "원, 출금 후 " + balance + "원");
      count++;
    }
  ...
  public static void method6() {
    ...
    String pw = "QWERTYUIOPASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnm0123456789";
    StringBuilder builder = new StringBuilder();
    for (int i = 0; i < num; i++) {
      int idx = random.nextInt(pw.length());
