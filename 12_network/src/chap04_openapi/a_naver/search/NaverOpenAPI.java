package chap04_openapi.a_naver.search;
...
public class NaverOpenAPI {
  ...
  public final static String clientId = "_OXP8zOw4irxgmPclBTU";  // 애플리케이션 등록 시 발급받은 클라이언트 아이디 값
  public final static String clientSecret = "2CSk83Mhqe";  // 애플리케이션 등록 시 발급받은 클라이언트 시크릿 값
