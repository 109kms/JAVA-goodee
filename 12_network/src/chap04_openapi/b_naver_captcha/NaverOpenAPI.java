...
public class NaverOpenAPI {
  ...
  public final static String clientId = "_OXP8zOw4irxgmPclBTU";
  public final static String clientSecret = "2CSk83Mhqe";
   ...
   */
  public static void captchaImage(String key) throws Exception{
